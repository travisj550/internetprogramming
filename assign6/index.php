...
<body>
    ...
    echo '<table align="center"><tr><td align="center" colspan="9"><h1>CPU Table</h1></td></tr>
    <tr><td align="left" colspan="9"><p>Information about different CPUs is listed below.<br>
    <ul>
        <li>To modify a CPU, click "Edit", make desired changes, and then click "Submit".<br></li>
        <li>To remove a CPU, click "Remove" and then "Confirm".<br></li>
        <li>To add a CPU, enter its specifications in the bottom row and then click "Add".</p></li>
    </ul></td></tr><tr><td>';
